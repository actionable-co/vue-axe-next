...
function render$9(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", _hoisted_1$7, [createElementVNode("h2", _hoisted_2$7, toDisplayString(_ctx.$vat('congrats', 'Congratulation')), 1), createElementVNode("p", _hoisted_3$5, " (0) " + toDisplayString(_ctx.$vat('no_issues')), 1), _hoisted_4$5]);
