'use strict';Object.defineProperty(exports,'__esModule',{value:true});var axeCore=require('axe-core'),vue=require('vue');function _interopDefaultLegacy(e){return e&&typeof e==='object'&&'default'in e?e:{'default':e}}var axeCore__default=/*#__PURE__*/_interopDefaultLegacy(axeCore);var commonjsGlobal = typeof globalThis !== 'undefined' ? globalThis : typeof window !== 'undefined' ? window : typeof global !== 'undefined' ? global : typeof self !== 'undefined' ? self : {};
...
var merge = /*@__PURE__*/getDefaultExportFromCjs(src);const defaultOptions = {
  auto: true,
  config: {
    branding: {
      application: 'vue-axe'
...
const impacts = [...axeCore__default["default"].constants.impact].reverse();
const vueAxe = Symbol('vue-axe');let lastNotification = 0;
function useAxe(axeOptions) {
  const results = vue.ref({});
  const error = vue.ref(null);
  const loading = vue.ref(false);
  axeCore__default["default"].configure({
    ...axeOptions.config
  });
  axeOptions.plugins.forEach(plugin => axeCore__default["default"].registerPlugin(plugin));
  function axeCoreRun(context, runOptions) {
    axeCore__default["default"].run(context, runOptions, (error, res) => {
      try {
  ...
  function run({
    ...
    vue.nextTick(() => axeCoreRun(context, runOptions));
  }
  ...
  return {
    ...
    results,
    loading,
    plugins: axeCore__default["default"].plugins
  };
}var ptBR = {
  run_again: 'Analisar',
  running: 'Analisando',
...
}var version = "3.1.2";function useVueAxe(options) {
  let timeout = null;
  const highlights = vue.ref(null);
...
const _hoisted_2$b = /*#__PURE__*/vue.createStaticVNode("<svg width=\"100\" height=\"100\" viewBox=\"0 0 60 60\" xmlns=\"http://www.w3.org/2000/svg\" fill=\"#41b883\"><g fill=\"41b883\" fill-rule=\"evenodd\"><g transform=\"translate(1 1)\" stroke-width=\"2\"><circle cx=\"5\" cy=\"50\" r=\"5\"><animate attributeName=\"cy\" begin=\"0s\" dur=\"2.2s\" values=\"50;5;50;50\" calcMode=\"linear\" repeatCount=\"indefinite\"></animate><animate attributeName=\"cx\" begin=\"0s\" dur=\"2.2s\" values=\"5;27;49;5\" calcMode=\"linear\" repeatCount=\"indefinite\"></animate></circle><circle cx=\"27\" cy=\"5\" r=\"5\"><animate attributeName=\"cy\" begin=\"0s\" dur=\"2.2s\" from=\"5\" to=\"5\" values=\"5;50;50;5\" calcMode=\"linear\" repeatCount=\"indefinite\"></animate><animate attributeName=\"cx\" begin=\"0s\" dur=\"2.2s\" from=\"27\" to=\"27\" values=\"27;49;5;27\" calcMode=\"linear\" repeatCount=\"indefinite\"></animate></circle><circle cx=\"49\" cy=\"50\" r=\"5\"><animate attributeName=\"cy\" begin=\"0s\" dur=\"2.2s\" values=\"50;50;5;50\" calcMode=\"linear\" repeatCount=\"indefinite\"></animate><animate attributeName=\"cx\" from=\"49\" to=\"49\" begin=\"0s\" dur=\"2.2s\" values=\"49;5;27;49\" calcMode=\"linear\" repeatCount=\"indefinite\"></animate></circle></g></g></svg>", 1);
const _hoisted_3$8 = [_hoisted_2$b];
function render$d(_ctx, _cache, $props, $setup, $data, $options) {
  return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$b, _hoisted_3$8);
...
const _hoisted_3$7 = /*#__PURE__*/vue.createElementVNode("svg", {
  class: "va-ml-1",
  fill: "none",
  stroke: "currentColor",
  width: "14",
...
function render$c(_ctx, _cache, $props, $setup, $data, $options) {
  return vue.openBlock(), vue.createElementBlock("a", _hoisted_1$a, [vue.renderSlot(_ctx.$slots, "default"), vue.createElementVNode("span", _hoisted_2$a, "(" + vue.toDisplayString(_ctx.$vat('open_new_tab')) + ")", 1), _hoisted_3$7]);
...
function render$b(_ctx, _cache, $props, $setup, $data, $options) {
  return vue.openBlock(), vue.createElementBlock("svg", _hoisted_1$9, [vue.createElementVNode("path", {
...
var referencesLinks = {
  ...
  const els = vue.ref(null);
  const {
    highlights
  } = vue.inject(vueAxe);
  vue.onUnmounted(reset);
...
(function () {
  ...
  setup(props) {
    ...
    const references = vue.computed(() => referencesLinks[props.details.id]);
...
const _hoisted_7$3 = /*#__PURE__*/vue.createElementVNode("path", {
...
const _hoisted_32 = /*#__PURE__*/vue.createElementVNode("span", {
  class: "va-text-blue-700 va-text-xl va-font-bold va-inline-block va-w-3 va-mt-1"
}, "•", -1);
function render$a(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_IconArrowNarrow = vue.resolveComponent("IconArrowNarrow");
  const _component_ExternalLink = vue.resolveComponent("ExternalLink");
  return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$8, [vue.createElementVNode("div", _hoisted_2$8, [vue.createElementVNode("button", {
    type: "button",
    class: "va-btn va-flex va-items-center va-px-2 va-py-3 va-relative",
    onClick: _cache[0] || (_cache[0] = $event => _ctx.$emit('hideDetails'))
  }, [vue.createVNode(_component_IconArrowNarrow), vue.createElementVNode("span", _hoisted_3$6, vue.toDisplayString(_ctx.$vat('back', 'Back')), 1)]), vue.createElementVNode("button", {
    type: "button",
    class: "va-btn va-flex va-items-center va-px-2 va-py-3 va-relative",
    onClick: _cache[1] || (_cache[1] = $event => $setup.toggleHighlight($props.details.nodes))
  }, [(vue.openBlock(), vue.createElementBlock("svg", _hoisted_4$6, [$setup.highlights ? (vue.openBlock(), vue.createElementBlock("g", _hoisted_5$3, _hoisted_8$3)) : (vue.openBlock(), vue.createElementBlock("g", _hoisted_9$3, _hoisted_12))])), vue.createElementVNode("span", _hoisted_13, vue.toDisplayString($setup.highlights ? _ctx.$vat('no_highlight', 'Stop highlight') : _ctx.$vat('highlight', 'Highlight')), 1)])]), vue.createElementVNode("section", {
  ...
  }, vue.toDisplayString(_ctx.$vat('issue_desc', 'Issue description')), 9, _hoisted_15), vue.createElementVNode("p", _hoisted_16, [vue.createTextVNode(vue.toDisplayString($props.details.description) + " ", 1), _hoisted_17, vue.createVNode(_component_ExternalLink, {
    ...
    }, vue.toDisplayString(_ctx.$vat('learn_more', 'Learn more')), 9, _hoisted_18)]),
    _: 1
  }, 8, ["href", "aria-labelledby"])])], 8, _hoisted_14), (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($props.details.failureSummary, (failure, index) => {
    return vue.openBlock(), vue.createElementBlock("section", {
      key: `failure-section-${index}`,
      class: "va-flex va-flex-wrap va-px-3 va-mb-8"
    }, [vue.createElementVNode("div", _hoisted_19, [vue.createElementVNode("h2", _hoisted_20, vue.toDisplayString(_ctx.$vat('el_src', 'Element source')), 1), vue.createElementVNode("div", _hoisted_21, [vue.createElementVNode("span", _hoisted_22, vue.toDisplayString(index + 1) + " / " + vue.toDisplayString($props.details.failureSummary.length), 1)])]), vue.createElementVNode("div", _hoisted_23, [vue.createElementVNode("pre", _hoisted_24, [vue.createElementVNode("code", {
      class: "va-w-full va-bg-gray-900 va-text-gray-100",
      innerHTML: $setup.getCodeBlock(failure.source)
    }, null, 8, _hoisted_25)])]), vue.createElementVNode("div", _hoisted_26, [vue.createElementVNode("h3", _hoisted_27, vue.toDisplayString(failure.errors.length > 1 ? _ctx.$vat('fixes') : _ctx.$vat('fix')) + ": ", 1), vue.createElementVNode("ul", _hoisted_28, [(vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(failure.errors, error => {
      return vue.openBlock(), vue.createElementBlock("li", {
        key: `error-item-${error.id}`,
        class: "va-flex va-items-start va-mt-3"
      }, [vue.createElementVNode("span", {
        class: vue.normalizeClass(`va-text-2xl va-font-bold va-leading-4 va-mr-2 va-text-${error.impact}`)
      }, "•", 2), vue.createElementVNode("p", null, vue.toDisplayString(error.message), 1)]);
    }), 128))])])]);
  }), 128)), vue.withDirectives(vue.createElementVNode("section", {
    "aria-labelledby": `references-${$props.details.id}`
  }, [vue.createElementVNode("h2", {
    id: `references-${$props.details.id}`,
    class: "va-p-item__header va-bg-primary va-flex va-justify-between va-font-medium va-p-3 va-border va-border-solid va-border-gray-300 va-text-base"
  }, vue.toDisplayString(_ctx.$vat('more_links', 'More links')), 9, _hoisted_30), vue.createElementVNode("ul", _hoisted_31, [(vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($setup.references, (reference, index) => {
    return vue.openBlock(), vue.createElementBlock("li", {
      key: `reference-item-${index}`,
      class: "va-flex"
    }, [_hoisted_32, vue.createVNode(_component_ExternalLink, {
      href: reference.link
    }, {
      default: vue.withCtx(() => [vue.createTextVNode(vue.toDisplayString(reference.title), 1)]),
      _: 2
    }, 1032, ["href"])]);
  }), 128))])], 8, _hoisted_29), [[vue.vShow, $setup.references.length]])]);
...
function render$7(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_IconArrowNarrow = vue.resolveComponent("IconArrowNarrow");
  const _component_WrapperCard = vue.resolveComponent("WrapperCard");
  return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$6, [vue.createElementVNode("div", _hoisted_2$6, [vue.createElementVNode("span", null, vue.toDisplayString($setup.results.issuesFound) + " " + vue.toDisplayString($setup.results.issuesFound > 1 ? _ctx.$vat('issues_found', 'issues found') : _ctx.$vat('issue_found', 'issue found')), 1)]), vue.createElementVNode("ul", _hoisted_3$4, [(vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($setup.results.impacts, (result, key) => {
    return vue.openBlock(), vue.createElementBlock("li", {
      key: key,
      class: "va-mb-4"
    }, [result.length ? (vue.openBlock(), vue.createElementBlock(vue.Fragment, {
      key: 0
    }, [vue.createElementVNode("div", _hoisted_4$4, [vue.createElementVNode("span", {
      class: vue.normalizeClass(`va-capitalize va-text-${key}`)
    }, vue.toDisplayString(_ctx.$vat(key, key)), 3), vue.createElementVNode("span", null, vue.toDisplayString(result.length) + " " + vue.toDisplayString(result.length > 1 ? _ctx.$vat('issues', 'issues') : _ctx.$vat('issue', 'issue')), 1)]), vue.createElementVNode("ul", _hoisted_5$2, [(vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(result, violation => {
      return vue.openBlock(), vue.createBlock(_component_WrapperCard, {
        ...
        default: vue.withCtx(() => [vue.createElementVNode("div", _hoisted_6$2, [vue.createElementVNode("span", {
          class: vue.normalizeClass(`va-text-${violation.impact} va-text-2xl va-font-bold va-leading-4 va-mr-2`)
        }, "•", 2), vue.createElementVNode("span", {
          id: `violation-${violation.id}`
        }, [vue.createTextVNode(vue.toDisplayString(violation.help) + ". ", 1), vue.withDirectives(vue.createElementVNode("em", null, " (" + vue.toDisplayString(`${violation.nodes.length}`) + " " + vue.toDisplayString(_ctx.$vat('els', 'elements')) + ") ", 513), [[vue.vShow, violation.nodes.length > 1]])], 8, _hoisted_7$2)]), vue.createElementVNode("button", {
          type: "button",
          ...
          class: "va-sr-only"
        }, vue.toDisplayString(_ctx.$vat('see_more', 'See more')), 9, _hoisted_9$2), vue.createVNode(_component_IconArrowNarrow, {
          right: ""
        })], 8, _hoisted_8$2)]),
        _: 2
      }, 1032, ["onTrigger"]);
    }), 128))])], 64)) : vue.createCommentVNode("", true)]);
  }), 128))])]);
}var css_248z$3 = "/* purgecss start ignore */\n\n.va-p-item__header {\n  border-radius: 8px 8px 0 0 ;\n}\n\n.va-p-subitem:not(:last-child) {\n  border-bottom: 1px solid var(--va-border-color);\n}\n\n.va-p-subitem:focus-within {\n  background-color: var(--va-primary);\n}\n\n/* purgecss end ignore */\n";
...
function render$6(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_PopupBodyViolations = vue.resolveComponent("PopupBodyViolations");
  const _component_PopupBodyDetails = vue.resolveComponent("PopupBodyDetails");
  const _component_PopupBodyNoIssues = vue.resolveComponent("PopupBodyNoIssues");
  const _component_PopupLoading = vue.resolveComponent("PopupLoading");
  return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$5, [$setup.results.issuesFound && !$setup.details ? (vue.openBlock(), vue.createBlock(_component_PopupBodyViolations, {
    key: 0,
    onShowDetails: $setup.toogleDetails
  }, null, 8, ["onShowDetails"])) : vue.createCommentVNode("", true), $setup.details ? (vue.openBlock(), vue.createBlock(_component_PopupBodyDetails, {
    key: 1,
    details: $setup.details,
    onHideDetails: _cache[0] || (_cache[0] = $event => $setup.toogleDetails(null))
  }, null, 8, ["details"])) : vue.createCommentVNode("", true), !$setup.results.issuesFound && !$setup.details ? (vue.openBlock(), vue.createBlock(_component_PopupBodyNoIssues, {
    key: 2
  })) : vue.createCommentVNode("", true), vue.withDirectives(vue.createVNode(_component_PopupLoading, null, null, 512), [[vue.vShow, $setup.loading]]), vue.createElementVNode("span", _hoisted_2$5, vue.toDisplayString($setup.details ? _ctx.$vat('announcer_details_view') : _ctx.$vat('announcer_violations_view')), 1)]);
}var css_248z$2 = "/* purgecss start ignore */\n\n.va-popup__body {\n  min-height: 300px;\n  max-height: 55vh;\n}\n\n@media (min-height: 569px) {\n  .va-popup__body {\n    max-height: 60vh;\n  }\n}\n\n.va-popup__body::-webkit-scrollbar {\n  width: 10px;\n}\n\n.va-popup__body::-webkit-scrollbar-thumb {\n  background: #DFE8E8;\n  border-radius: 20px;\n}\n\n.va-popup__body::-webkit-scrollbar-track {\n  background: #F2F8F8;\n  border-radius: 20px;\n}\n\n/* purgecss end ignore */\n";
styleInject(css_248z$2);script$6.render = render$6;var script$5 = {
  ...
  return $setup.highlights ? (vue.openBlock(true), vue.createElementBlock(vue.Fragment, {
    key: 0
  }, vue.renderList($setup.highlights, (highlight, index) => {
  ...
  disableAxeAudit: true,
  setup(props) {
    const ariaLabelButton = vue.computed(() => `${props.popupShow ? 'Close' : 'Open'} vue axe popup`);
    return {
      ariaLabelButton
    };
  }
...
function render$4(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, [vue.withDirectives(vue.createElementVNode("span", _hoisted_2$4, [vue.createTextVNode(vue.toDisplayString($props.notifications) + " ", 1), vue.createElementVNode("span", _hoisted_3$3, vue.toDisplayString(Number($props.notifications) > 1 ? _ctx.$vat('btn_label_plu') : _ctx.$vat('btn_label')), 1)], 512), [[vue.vShow, $props.notifications && !$props.popupShow]]), vue.withDirectives((vue.openBlock(), vue.createElementBlock("svg", _hoisted_4$3, _hoisted_6$1, 512)), [[vue.vShow, !$props.popupShow]]), vue.withDirectives((vue.openBlock(), vue.createElementBlock("svg", _hoisted_7$1, _hoisted_9$1, 512)), [[vue.vShow, $props.popupShow]])], 8, _hoisted_1$4);
}var css_248z$1 = "/* purgecss start ignore */\n\n.va-popup-btn {\n  box-shadow: 2px 2px 3px 2px #dfdfdf;\n  transition: box-shadow .1s;\n}\n\n.va-popup-btn:focus, .va-popup-btn:hover {\n    box-shadow: 0 0 0 3px var(--va-outline-color);\n  }\n\n.va-popup-btn > span {\n    left: -10px;\n    top: -10px;\n  }\n\n/* purgecss end ignore */\n";
...
const _hoisted_7 = /*#__PURE__*/vue.createElementVNode("g", {
  fill: "#34495f",
  stroke: "#34495f",
  "stroke-width": "1.2"
}, [/*#__PURE__*/vue.createElementVNode("path", {
...
function render$3(_ctx, _cache, $props, $setup, $data, $options) {
  return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$3, [vue.createElementVNode("a", _hoisted_2$3, [(vue.openBlock(), vue.createElementBlock("svg", _hoisted_3$2, [vue.createElementVNode("title", _hoisted_4$2, "Vue aXe (" + vue.toDisplayString(_ctx.$vat('open_new_tab')) + ")", 1), _hoisted_5, _hoisted_6, _hoisted_7]))]), vue.createElementVNode("div", _hoisted_8, [vue.createElementVNode("span", null, "v" + vue.toDisplayString($setup.versions.vueAxe) + " (vue-axe)", 1), vue.createTextVNode(), _hoisted_9, vue.createElementVNode("span", null, "v" + vue.toDisplayString($setup.versions.axeCore) + " (axe-core) ", 1)])]);
...
function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, _hoisted_3$1, 2)), vue.createElementVNode("span", _hoisted_4$1, vue.toDisplayString($setup.loading ? _ctx.$vat('running', 'Running') : _ctx.$vat('run_again', 'Run again')), 1)])]);
...
var script$1 = {
  ...
  disableAxeAudit: true,
  setup(props) {
    const focusLoopRef = vue.ref(null);
    const alreadyFocused = vue.ref(false);
    const getTabindex = vue.computed(() => props.disabled ? -1 : 0);
    vue.watch(() => props.isVisible, focusFirst);
    vue.onMounted(() => focusFirst(props.isVisible || true));
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, null, 40, _hoisted_2$1), vue.createElementVNode("div", _hoisted_3, [vue.renderSlot(_ctx.$slots, "default")], 512), vue.createElementVNode("div", {
    tabindex: $setup.getTabindex,
  ...
  setup() {
    ...
    const issuesFound = vue.computed(() => {
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_PopupHeader = vue.resolveComponent("PopupHeader");
  const _component_PopupBody = vue.resolveComponent("PopupBody");
  const _component_PopupFooter = vue.resolveComponent("PopupFooter");
  const _component_PopupButton = vue.resolveComponent("PopupButton");
  const _component_FocusLoop = vue.resolveComponent("FocusLoop");
  const _component_Highlight = vue.resolveComponent("Highlight");
  return vue.openBlock(), vue.createElementBlock(vue.Fragment, null, [vue.createVNode(_component_FocusLoop, null, {
    default: vue.withCtx(() => [vue.createElementVNode("div", {
      ...
      default: vue.withCtx(() => [vue.withDirectives(vue.createElementVNode("div", _hoisted_2, [vue.createVNode(_component_PopupHeader), vue.createVNode(_component_PopupBody), vue.createVNode(_component_PopupFooter)], 512), [[vue.vShow, $setup.isOpen]])]),
      _: 1
    }), vue.createVNode(_component_PopupButton, {
    ...
    _: 1
  }), vue.createVNode(_component_Highlight)], 64);
...
styleInject(css_248z);script.render = render;function install(app, options = {}) {
  ...
  registerPlugin(app);
}exports.VueAxePopup=script;exports["default"]=install;